  ...
  return (
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-4">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
        ...
        <Link 
          to="/campaigns/new" 
          className="bg-blue-500 hover:bg-blue-600 text-white font-medium py-2 px-4 rounded w-full sm:w-auto text-center"
        >
          Create Campaign
        </Link>
      </div>
          ...
          <div className="md:hidden space-y-4">
            {campaigns.map((campaign) => (
              <div key={campaign._id} className="bg-white shadow rounded-lg p-4">
                <div className="font-medium text-lg text-gray-900 mb-1">{campaign.name}</div>
                <div className="text-sm text-gray-500 mb-2">{campaign.description}</div>
